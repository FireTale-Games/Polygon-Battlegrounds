...
{
    public class LobbyManagerTesting : MonoBehaviour
    {

        public static LobbyManagerTesting Instance { get; private set; }
        ...
        private bool IsPlayerInLobby() =>
            joinedLobby is { Players: not null } &&
            joinedLobby.Players.Any(player => player.Id == AuthenticationService.Instance.PlayerId);
